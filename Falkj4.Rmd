...
# There could be two Modalwerten if the both appear with the same frequency in a group of numbers.  The R-code seemed as if it would only give one Modalwert though.
