...
#überlassen. frauen.studiengang.bw <- CODE_HIER print(frauen.studiengang.bw<-CODE_HIER 
#print(frauen.studiengang.bw)frauen.studiengang.bw<-
library(ggplot2)
frauen.studiengang.bw<-ggplot(data=dat)+geom_boxplot(aes(x=major,y=height))
